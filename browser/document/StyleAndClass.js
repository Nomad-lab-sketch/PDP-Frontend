...
// classList – объект с методами add/remove/toggle/contains, удобно для управления 
// отдельными классами.
...
//  Чтобы узнать, как добавить в него important и делать некоторые другие редкие 
// вещи – смотрите документацию.
